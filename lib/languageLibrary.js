...
const languageLibrary = {
  accordion: {
    ...
    how_to_use_add_reviews: {
      EN: 'Then add new reviews, edit your existing ones, or delete them.',
      DE: 'Fügen Sie anschließend neue Bewertungen (Reviews) hinzu, ändern Sie Ihre bereits erstellten oder löschen Sie diese.',
    },
    how_to_use_reviews_saved: {
      EN: 'Your reviews as a logged-in user are permanently stored in a database.',
      DE: 'Ihre Reviews als eingeloggter Benutzer werden dauerhaft in einer Datenbank gespeichert.',
    },
    how_to_use_reviews_demo: {
      EN: 'As a Demo User, you can create reviews, but they will not be saved.',
      DE: 'Als Demo-Benutzer können Sie Reviews erstellen, diese werden jedoch nicht gespeichert.',
    },
    ...
    how_to_use_forgot_password: {
      EN: 'Test the "Forgot Password" functionality with your user account.',
      DE: 'Testen Sie mit Ihrem Benutzerkonto auch die ”Passwort vergessen“-Funktion.',
    },
    how_to_use_leave_message: {
      EN: 'Leave me a message in a review! :)',
      DE: 'Hinterlassen Sie mir eine Nachricht in einem Review! :)',
    },
  },
  ...
  infoProject: {
    ...
    title: { EN: '#GMNDR Auth Demo', DE: '#GMNDR Auth Demo' },
    welcome_message: {
      EN: 'and welcome to a project created by Markus Gemeinder in 2024 using Next.js 14 and a backend database connection to MongoDB. All functionalities are original developments created from scratch.',
      DE: 'und herzlich willkommen zu einem Projekt, das 2024 von Markus Gemeinder mit Next.js 14 und einer Backend-Datenbankanbindung zu MongoDB realisiert wurde. Alle Funktionalitäten sind Eigenentwicklungen, die von Grund auf neu erstellt wurden.',
    },
  },
