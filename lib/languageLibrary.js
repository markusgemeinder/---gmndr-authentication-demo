...
const languageLibrary = {
  ...
  utils_email_template: {
    ...
    email_subject_password_reset: {
      EN: 'Email Confirmation | #GMNDR Authentication Demo',
      DE: 'E-Mail-Bestätigung | #GMNDR Authentifizierungsdemo',
    },
    email_subject_registration: {
      EN: 'Password Reset | #GMNDR Authentication Demo',
      DE: 'Passwort zurücksetzen | #GMNDR Authentifizierungsdemo',
    },
