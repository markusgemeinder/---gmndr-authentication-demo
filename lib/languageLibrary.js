...
const languageLibrary = {
  ...
  navigation: {
    ...
    aria_label_auth_button_login: { EN: 'Login', DE: 'Anmelden' },
    aria_label_auth_button_logout: { EN: 'Logout', DE: 'Abmelden' },
    aria_label_auth_button_register: { EN: 'Register', DE: 'Registrieren' },
